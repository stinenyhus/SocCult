...
mtest <- generate_moore(n = 20000, p = 10^-2, nei = 2)
...
```
```{r}
contagion_sim <- function(condition = "base_tau", high_status = F, rep, net_type = "moore", rounds, tau = 0, n, nei, p = 0, n_high, degrees = 0, gamma = 0){ #assumption network
...
if(condition == "random_tau"){
  #INDSÆT random tau  
  #HVAD ER VÆRDIERNE??
   tau_norm <- rnorm(nrow(adj),0.3333333,  0.1666666) #ÆNDR VÆRDIER HER 
